 ...
 * </p>
 * <ul>
 *   <li>{@link umlrtsyntesizer.constLang.impl.ValueImpl#isMinues <em>Minues</em>}</li>
 *   <li>{@link umlrtsyntesizer.constLang.impl.ValueImpl#getValue <em>Value</em>}</li>
 *   <li>{@link umlrtsyntesizer.constLang.impl.ValueImpl#getFixedPointValue <em>Fixed Point Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ValueImpl extends MinimalEObjectImpl.Container implements Value
{
  ...
  {
    return ConstLangPackage.Literals.VALUE;
  }
  ...
  public void setMinues(boolean newMinues)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ConstLangPackage.VALUE__MINUES, oldMinues, minues));
  }
  ...
  public void setValue(int newValue)
  {
    ...
    value = newValue;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ConstLangPackage.VALUE__VALUE, oldValue, value));
  }
  ...
  public NotificationChain basicSetFixedPointValue(RealLiteral newFixedPointValue, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ConstLangPackage.VALUE__FIXED_POINT_VALUE, oldFixedPointValue, newFixedPointValue);
  ...
  public void setFixedPointValue(RealLiteral newFixedPointValue)
  {
    if (newFixedPointValue != fixedPointValue)
    {
      ...
      if (fixedPointValue != null)
        msgs = ((InternalEObject)fixedPointValue).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ConstLangPackage.VALUE__FIXED_POINT_VALUE, null, msgs);
      if (newFixedPointValue != null)
        msgs = ((InternalEObject)newFixedPointValue).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ConstLangPackage.VALUE__FIXED_POINT_VALUE, null, msgs);
      msgs = basicSetFixedPointValue(newFixedPointValue, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ConstLangPackage.VALUE__FIXED_POINT_VALUE, newFixedPointValue, newFixedPointValue));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case ConstLangPackage.VALUE__FIXED_POINT_VALUE:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case ConstLangPackage.VALUE__MINUES:
        return isMinues();
      case ConstLangPackage.VALUE__VALUE:
        return getValue();
      case ConstLangPackage.VALUE__FIXED_POINT_VALUE:
