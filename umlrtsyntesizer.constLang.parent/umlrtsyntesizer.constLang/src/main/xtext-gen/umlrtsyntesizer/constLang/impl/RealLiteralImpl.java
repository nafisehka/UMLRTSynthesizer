 ...
 * </p>
 * <ul>
 *   <li>{@link umlrtsyntesizer.constLang.impl.RealLiteralImpl#getIntPart <em>Int Part</em>}</li>
 *   <li>{@link umlrtsyntesizer.constLang.impl.RealLiteralImpl#getDecimalPart <em>Decimal Part</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RealLiteralImpl extends LiteralImpl implements RealLiteral
{
  ...
  {
    return ConstLangPackage.Literals.REAL_LITERAL;
  }
  ...
  public void setIntPart(int newIntPart)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ConstLangPackage.REAL_LITERAL__INT_PART, oldIntPart, intPart));
  }
  ...
  public void setDecimalPart(int newDecimalPart)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ConstLangPackage.REAL_LITERAL__DECIMAL_PART, oldDecimalPart, decimalPart));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case ConstLangPackage.REAL_LITERAL__INT_PART:
        return getIntPart();
      case ConstLangPackage.REAL_LITERAL__DECIMAL_PART:
